...
| **NEVOD DIY (датчик)** | Подписанный `.bin` с распознанием **трёх классов БПЛА** на ESP32-S3. [`v0.18.18-ota`](https://github.com/Gfermoto/UAV-radar/releases/tag/v0.18.18-ota) · полная сборка [DIY_GUIDE.md](docs/DIY_GUIDE.md) |
...
| Бинарник датчика | [`v0.18.18-ota`](https://github.com/Gfermoto/UAV-radar/releases/tag/v0.18.18-ota) · [канал `diy-ota`](https://github.com/Gfermoto/UAV-radar/releases/tag/diy-ota) |
...
| **NEVOD DIY (sensor)** | Signed `.bin` with **three UAV classes** on ESP32-S3. [`v0.18.18-ota`](https://github.com/Gfermoto/UAV-radar/releases/tag/v0.18.18-ota) · full build [DIY_GUIDE.md](docs/DIY_GUIDE.md#english) |
...
| Sensor binary | [`v0.18.18-ota`](https://github.com/Gfermoto/UAV-radar/releases/tag/v0.18.18-ota) · [channel `diy-ota`](https://github.com/Gfermoto/UAV-radar/releases/tag/diy-ota) |
