# Сборка и прошивка · Build & flash

**[Русский](#русский)** · **[English](#english)**

Как собрать и прошить **открытую прошивку mic** из исходников. Для бинарника NEVOD DIY с детекцией — [docs/DIY_GUIDE.md](docs/DIY_GUIDE.md).
...
В WebUI **Кольцо** — RGB Seeed (`LED_EFFECT` 0 / 4), не только GPIO21. В UART:
...
- [PlatformIO](https://platformio.org/) Core or VS Code / Cursor extension
- USB access to Seeed XIAO ESP32-S3
...
XVF I2C address `0x2C`. Mic RGB ring is **not** GPIO21 — see [docs/LED.md](docs/LED.md).
